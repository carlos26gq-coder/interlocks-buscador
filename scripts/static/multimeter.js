...
(function (window, document) {
    ...
    const OFFLINE_CATALOG = {
        "TP1": {
            id: "TP1", code: "TP1", name: "Punto de Prueba TP1",
            subsystem: "safety_loop", subsystem_name: "Bucle de Seguridad de Interlocks",
            mode: "voltage_dc", unit: "V", nominal: 24.0,
            tolerance_min: 23.2, tolerance_max: 24.8, warning_low: 23.5, warning_high: 24.5,
        ...
        "TP2": {
            id: "TP2", code: "TP2", name: "Punto de Prueba TP2",
            subsystem: "safety_loop", subsystem_name: "Bucle de Seguridad de Interlocks",
            mode: "voltage_dc", unit: "V", nominal: 24.0,
            tolerance_min: 23.0, tolerance_max: 24.8, warning_low: 23.4, warning_high: 24.5,
        ...
        "TP5": {
            ...
            subsystem: "safety_loop", subsystem_name: "Bucle de Seguridad de Interlocks",
            mode: "voltage_dc", unit: "V", nominal: 24.0,
            tolerance_min: 22.8, tolerance_max: 25.0, warning_low: 23.2, warning_high: 24.6,
        ...
        "TP3": {
            id: "TP3", code: "TP3", name: "Punto de Prueba TP3",
            subsystem: "radiation_beam", subsystem_name: "Habilitación de Radiación y Modulador RF",
            mode: "voltage_pulse", unit: "V", nominal: 800.0,
            tolerance_min: 720.0, tolerance_max: 880.0, warning_low: 740.0, warning_high: 860.0,
        ...
        "TP_HT": {
            ...
            subsystem: "radiation_beam", subsystem_name: "Habilitación de Radiación y Modulador RF",
            mode: "voltage_dc", unit: "V", nominal: 14.0,
            tolerance_min: 10.0, tolerance_max: 18.0, warning_low: 11.0, warning_high: 17.0,
        ...
        "TP_RF": {
            ...
            tolerance_min: 4.2, tolerance_max: 5.8, warning_low: 4.5, warning_high: 5.5,
        ...
        "TP100": {
            ...
            subsystem: "dosimetry", subsystem_name: "Dosimetría y Doble Canal Independiente",
            mode: "voltage_dc", unit: "V", nominal: 400.0,
            tolerance_min: 395.0, tolerance_max: 405.0, warning_low: 397.0, warning_high: 403.0,
        ...
        "TP_DOSE1": {
            ...
            subsystem: "dosimetry", subsystem_name: "Dosimetría y Doble Canal Independiente",
            mode: "voltage_dc", unit: "V", nominal: 4.0,
        ...
        "TP_SPEED": {
            ...
            mode: "voltage_dc", unit: "V", nominal: 0.0,
            tolerance_min: -10.0, tolerance_max: 10.0, warning_low: -9.0, warning_high: 9.0,
        ...
        "TP_VAC": {
            id: "TP_VAC", code: "TP_VAC", name: "Punto de Prueba TP_VAC",
            subsystem: "vacuum_gun", subsystem_name: "Control de Vacío y Cañón de Electrones",
            mode: "voltage_dc", unit: "V", nominal: 2.0,
            tolerance_min: 1.2, tolerance_max: 2.8, warning_low: 1.5, warning_high: 2.5,
        ...
        "TP_GUN": {
            id: "TP_GUN", code: "TP_GUN", name: "Punto de Prueba TP_GUN",
            subsystem: "vacuum_gun", subsystem_name: "Control de Vacío y Cañón de Electrones",
            mode: "voltage_dc", unit: "V", nominal: 1.8,
            tolerance_min: 1.7, tolerance_max: 1.9, warning_low: 1.72, warning_high: 1.88,
        ...
        "TP7": {
            ...
            subsystem: "vacuum_gun", subsystem_name: "Control de Vacío y Cañón de Electrones",
            mode: "voltage_dc", unit: "V", nominal: -150.0,
            tolerance_min: -165.0, tolerance_max: -135.0, warning_low: -160.0, warning_high: -140.0,
